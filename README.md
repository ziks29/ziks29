...
I build full-stack web applications, Telegram Mini Apps, and on-chain products on TON. My focus is clean architecture and shipping things that work — from database schema to frontend. Currently expanding into Lua scripting for FiveM/RedM game servers.
...
| **Blockchain** | TON · TonConnect · Telegram Mini Apps (WebApp API) |
| **Infrastructure** | Docker · Linux VPS · GitHub Actions |
| **Learning** | Lua · FiveM · RedM game scripting |
...
![Stats](https://github-stats-alpha.vercel.app/api?username=ziks29&cc=0d1117&tc=ffffff&ic=79c0ff&bc=0d1117)

<br/>

![Activity](https://github-activity-graph.vercel.app/graph?username=ziks29&theme=tokyo-night&hide_border=true&area=true)
